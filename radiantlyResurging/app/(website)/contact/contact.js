      ...
      <div className="my-10 grid md:grid-cols-2">
        <div className="my-10">
          <h2 className="text-2xl font-semibold dark:text-white">
            Contact Radiantly Resurging
          </h2>
          <p className="mt-5 max-w-sm">
            If you have any questions, feedback, or just want to say
            hello, feel free to reach out to us. We love hearing from
            our community and are here to assist you in any way we
            can.
          </p>
          <p className="mt-5 max-w-sm">
            Thank you for being a part of our journey, and we look
            forward to connecting with you!
          </p>
          <p className="mt-5 max-w-sm">
            We appreciate your support and interest in Radiantly
            Resurging.
          </p>
          <p className="mt-5 max-w-sm">
